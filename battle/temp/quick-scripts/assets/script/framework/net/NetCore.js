(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/framework/net/NetCore.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'dc178BWasFILrQAFUK9cp2l', 'NetCore', __filename);
// script/framework/net/NetCore.js
...
(function () {
    ...
    NetCore.Connect = function (url, onConnected, onMsgIn, onError, onClosed, onReconnectFailed) {
        ...
        this.ws.onmessage = function (received) {
            if (CC_WECHATGAME) {
                _this2.deserializeMsg(new Uint8Array(received.data));
            } else if (!cc.sys.isNative) {
                (function () {
                    var reader = new FileReader();
                    reader.readAsArrayBuffer(received.data);
                    reader.onload = function (e) {
                        _this2.deserializeMsg(new Uint8Array(reader.result));
                    };
                })();
            } else {
                _this2.deserializeMsg(new Uint8Array(received.data));
