(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/framework/utils/Extentions.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '52c8atQlWZHJ441NorNa8WV', 'Extentions', __filename);
// script/framework/utils/Extentions.js
...
String.prototype.formatList = function (value) {
    var args = value;
    if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) != 'object' && typeof value != 'array') args = arguments;
...
var toArtNumber = function toArtNumber(paramNumber, symbol) {
    paramNumber *= 10000;
    if (symbol) {
...
cc.Node.prototype.setNodeColor = function (color) {
    var setColor = function setColor(node, color) {
        node.color = color;
...
cc.Node.prototype.setEnabled = function (enabled) {
    ...
    var setEnabled = function setEnabled(node, enabled) {
...
cc.Widget.prototype.start = function () {
    ...
    if (1 == this.alignMode) game.EventManager.on('ON_WINDOWS_RESIZE', function () {
        if (cc.isValid(_this.node)) _this.updateAlignment();
    }, this.node);
};
