(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/script/framework/utils/underscore.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c46f1LRTSBF0Zjln4MgoUYQ', 'underscore', __filename);
// script/framework/utils/underscore.js
  ...
  _.each = _.forEach = function (obj, iteratee, context) {
    ...
    if (length === +length) {
      ...
      for (i = 0, length = keys.length; i < length; i++) {
        iteratee(obj[keys[i]], keys[i], i, obj);
      }
    }
    return obj;
  };
